...
/// <summary>
/// Represents the `fizz` case of fizz buzz as a <see cref="WorkerProcess{T}" />.
/// </summary>
internal sealed class FizzWorker : WorkerProcess<int> {
    ...
    /// </summary>
    public FizzWorker(WorkerProcess<int> processor) : base(processor) { }
