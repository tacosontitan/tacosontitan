...
/// </summary>
internal sealed class BuzzHandler : ChainedHandler<int>
{
    /// <summary>
    /// Creates a new instance of <see cref="BuzzHandler" />.
    /// </summary>
    public BuzzHandler(ChainedHandler<int> processor) : base(processor) { }
    /// <summary>
